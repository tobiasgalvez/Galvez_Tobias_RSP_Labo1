...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    if(this!=NULL && index >= 0 && index < ll_len(this))
    {
    	aux = getNode(this, index);//obtengo el elemento a modificar
    	if(aux !=NULL)
    	{
	    	...
	    	if(index < ll_len(this))
	    	{
	    		...
	    		if(pNodeAux != NULL)
	    		{
	    			...
	    			else
	    			{
	    				...
	    				if(pNodePrev != NULL)//if innecesario
	    				{
...
int ll_clear(LinkedList* this)
{
	int returnAux = -1;
	    if(this != NULL)
	    {
	    		...
	    		{
	    			ll_remove(this,0);//elimina siempre el primero
	    			returnAux = 0;
	    		}
	    }
...
void* ll_pop(LinkedList* this,int index)
{
	...
	void* pAux = NULL;
	    ...
	    if(this != NULL && index >= 0 && index < ll_len(this))
	    {
			...
			if(!ll_remove(this,index)) //if innecesario
			{
				returnAux = pAux;
			}
	    }
    ...
    if(this != NULL && (order==1 || order==0) && pFunc!=NULL)
    {
    	...
    	for(int i=0; i<ll_len(this)-1 ;i++)
    	{
    		for(int j=i+1; j<ll_len(this) ;j++)
    		{
    			...
    			if((pFunc(pElementI,pElementJ)>0 && order==1) || (pFunc(pElementI,pElementJ)<0 && order==0))//si es p1 es mayor a p2, ascendente
    			{
...
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void*))
{
    ...
    if( this!= NULL && pFunc != NULL)
    {
        ...
        if(filter!=NULL)
        {
            for(int i=0; i < ll_len(this); i++)
            {
                if(pFunc(ll_get(this,i))==1)//si me da 1, debo agregar el elemento a la lista
                {
...
LinkedList* ll_map(LinkedList* this, void* (*pFunc)(void*))
{
	...
	if(this != NULL && pFunc != NULL)
	{
		...
		if(listaMap != NULL)
		{
			for(int i=0;i<ll_len(this);i++)
			{
				ll_add(listaMap, pFunc(ll_get(this, i)));
			}
		}
...
función map retornará la cantidad de elementos que pasaron el criterio.*/
	 ...
	 if(this!= NULL && pFunc != NULL)
	    {
		 for(int i=0; i < ll_len(this); i++)
		 {
		       if(pFunc(ll_get(this,i))==1)//si me da 1, aumento el contador
		       {
		         contador++;
		       }
		     }
