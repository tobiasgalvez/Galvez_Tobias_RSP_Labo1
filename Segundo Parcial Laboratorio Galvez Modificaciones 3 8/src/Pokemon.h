...
/**
 * Funcion que permite realizar la modificación del valor del ataque cargado según el siguiente criterio:
...
/**
 * Funcion que permite  averiguar si un pokémon es
 ...
 * @param elemento
 * @return 1 si el pokemon cumple con los requisitos, -1 si no
 */
